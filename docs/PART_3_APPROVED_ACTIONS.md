...
Pending Wave D work after threading qualification: approved social publishing. Social publishing must register through the same consequential-action policy and pass the same approval/receipt boundary rather than acquiring permission from model-generated text.
