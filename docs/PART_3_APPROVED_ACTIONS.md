...
Pending Wave D work after this qualification should be selected from the architecture roadmap rather than widening social authority implicitly. Organization publishing, media, social reads, scheduling, edits/deletes, engagement actions, and Agent publishing remain separate future decisions.
